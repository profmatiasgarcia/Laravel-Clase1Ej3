...
<head>
    ...
    <title>Clase Laravel 1 - Ejemplo 3</title>
...
<body>
    <div class="flex-center position-ref full-height">
        ...
        <div class="content">
            ...
            <div class="links">
                <a href="{{ route ('ejCSS') }}">Ejemplo CSS</a>
                <a href="{{ route ('ejBOOTSTRAP') }}">Ejemplo Bootstrap</a>
                <a href="{{ route ('ejBOOTSTRAP2') }}">Ejemplo Bootstrap 2</a>
                <a href="{{ route ('ejMATERIALDESIGN') }}">Ejemplo Material Design</a>
